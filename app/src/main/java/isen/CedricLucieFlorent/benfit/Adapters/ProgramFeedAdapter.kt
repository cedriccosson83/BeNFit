...
class ProgramFeedAdapter (val programs: ArrayList<ProgramFeed>,
    ...
    class ProgramViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun countLikes(program: ProgramFeed) {
            ...
            view.showProgramLike.text = "${count}"
        ...
        fun showLike(program: ProgramFeed) {
            ...
            if (likes.all { it != currentUserID }) {
                ...
                view.showProgramLikeIcon.setImageResource(R.drawable.dislike)

            }
        }
        fun bind(program: ProgramFeed,
                 clickListenersubscribe: (ProgramFeed) -> Unit,
            ...
            view.showProgramLikeIcon.setOnClickListener { clickListenerlike(program) }
